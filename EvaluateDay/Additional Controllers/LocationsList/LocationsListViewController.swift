...
class LocationsListViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        sendEvent(Analytics.locationsValueList, withProperties: nil)
    }
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: contentCell, for: indexPath) as! LocationListCell
        
        cell.street.text = value.streetString
        cell.otherAddress.text = value.otherAddressString
        cell.coordinates.text = value.coordinatesString
