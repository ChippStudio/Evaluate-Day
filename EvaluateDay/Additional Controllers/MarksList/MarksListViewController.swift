...
class MarksListViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        sendEvent(Analytics.marksValueList, withProperties: nil)
    }
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: contentCell, for: indexPath) as! MarkListCell
        
        cell.dateLabel.text = DateFormatter.localizedString(from: value.created, dateStyle: .medium, timeStyle: .short)
        cell.commentLabel.text = value.text
