...
class NumbersListViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        sendEvent(Analytics.numbersValueList, withProperties: nil)
    }
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if self.card.type == .criterionThree {
            cell.textLabel?.text = self.emogi(forValue: value.value)
        } else {
            cell.textLabel?.text = "\(value.value)"
        }
        cell.detailTextLabel?.text = DateFormatter.localizedString(from: value.created, dateStyle: .medium, timeStyle: .short)
