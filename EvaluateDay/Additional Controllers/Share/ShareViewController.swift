...
class ShareViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.closeButton.setImage(#imageLiteral(resourceName: "closeCircle").resizedImage(newSize: CGSize(width: 30.0, height: 30.0)), for: .normal)
        self.closeButton.imageView?.tintColor = style.shareControllerCloseTintColor
