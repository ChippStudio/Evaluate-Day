...
class OnChatMessageCell: UITableViewCell, OnChatBubbleCell {
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        let leadingConstraintCover = NSLayoutConstraint(item: self.cover, attribute: .leading, relatedBy: .equal, toItem: self.contentView, attribute: .leading, multiplier: 1.0, constant: 20.0)
        let trailingConstraintCover = NSLayoutConstraint(item: self.cover, attribute: .trailing, relatedBy: .lessThanOrEqual, toItem: self.contentView, attribute: .trailing, multiplier: 1.0, constant: -60.0)
