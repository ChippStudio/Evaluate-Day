...
internal enum Images {
  ...
  internal enum Media {
    ...
    internal static let cardQA = ImageAsset(name: "cardQA")
    ...
    internal static let collectionsQA = ImageAsset(name: "collectionsQA")
    ...
    internal static let empty0 = ImageAsset(name: "empty0")
    internal static let empty1 = ImageAsset(name: "empty1")
