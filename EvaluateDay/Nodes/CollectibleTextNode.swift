...
class CollectibleTextNode: ASCellNode {
    ...
    init(title: String, image: UIImage, data: String) {
        ...
        self.dataNode.attributedText = NSAttributedString(string: data, attributes: [NSAttributedString.Key.font: UIFont.preferredFont(forTextStyle: .caption1), NSAttributedString.Key.foregroundColor: UIColor.main])
