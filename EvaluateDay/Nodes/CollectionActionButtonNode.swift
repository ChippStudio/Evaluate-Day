...
class CollectionActionButtonNode: ASCellNode {
    ...
    override init() {
        ...
        self.text.attributedText = NSAttributedString(string: Localizations.Collection.addNew, attributes: [NSAttributedString.Key.font: UIFont.preferredFont(forTextStyle: .body), NSAttributedString.Key.foregroundColor: UIColor.textTint])
