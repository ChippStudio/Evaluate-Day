...
private enum JournalSettingsNodeType {
    case sectionTitle
    case title
    case subtitles
    case separator
...
class JournalEditableSection: ListSectionController, ASSectionController, EditableSection {
    // MARK: - Variable
    var card: Card!
    ...
    private var nodes = [JournalSettingsNodeType]()
