...
private enum ListSettingsNodeType {
    case sectionTitle
    case title
    case subtitles
    case separator
...
class ListEditableSection: ListSectionController, ASSectionController, EditableSection {
    // MARK: - Variable
    var card: Card!
    ...
    private var nodes = [ListSettingsNodeType]()
