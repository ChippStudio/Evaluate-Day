...
class CriterionThreeEvaluateSection: ListSectionController, ASSectionController, EvaluableSection {
    ...
    @objc private func shareAction(sender: ASButtonNode) {
        ...
        let sv = ShareView(view: EvaluateCriterionThreeShareView(value: value, positive: criterionCard.positive, title: self.card.title, subtitle: self.card.subtitle, date: self.date))
        ...
        let linkObject = BranchUniversalObject(canonicalIdentifier: "criterionThreeShare")
