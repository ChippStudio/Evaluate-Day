...
class CheckInMergeSection: ListSectionController, ASSectionController, MergeSection {
    // MARK: - Variable
    var card: Card!
                ...
                node.didPressed = { () in
                    if self.selectedIndex == nil {
                        ...
                        try! Database.manager.data.write {
                            for value in (otherCard.data as! CheckInCard).values {
