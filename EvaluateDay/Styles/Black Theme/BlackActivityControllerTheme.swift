//
//  BlackActivityControllerTheme.swift
//  EvaluateDay
//
...
struct BlackActivityControllerTheme: ActivityControllerStyle {
    ...
    var settingsTintColor: UIColor { return UIColor.smokyBlack }
    ...
    var userInformationFacebookButtonHighlightedColor: UIColor { return UIColor.smokyBlack }
    ...
    var statisticDataCellBackground: UIColor { return UIColor.smokyBlack }
    ...
    var titleTitleFont: UIFont { return UIFont.avenirNext(size: 24.0, weight: .regular) }
    ...
    // MARK: - LoadViewStyle
    var loadCircleColor: UIColor { return UIColor.smokyBlack }
