...
struct LightTopControllerTheme: TopViewControllerStyle {
    var maskColor: UIColor { return UIColor.black }
    var maskAlpha: CGFloat { return 0.6 }
    var topViewColor: UIColor { return UIColor.white }
    ...
    var buttonsColor: UIColor { return UIColor.black }
}
